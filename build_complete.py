  ...
  <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm p-8 text-center">
    ...
    <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
      ...
      <div class="flex flex-col sm:flex-row gap-3 justify-center max-w-lg mx-auto">
        <a href="https://centralsp3.github.io/TESTEDISC/" class="flex-1 px-6 py-3 rounded-full font-semibold text-sm bg-[#1a1a2e] text-white shadow-lg text-center transition-all ring-2 ring-amber-400 ring-offset-2 dark:ring-offset-gray-800">Perfil DISC</a>
        <a href="https://centralsp3.github.io/PERSONALIDADE/" class="flex-1 px-6 py-3 rounded-full font-semibold text-sm bg-white dark:bg-gray-700 border-2 border-purple-400 text-purple-700 dark:text-purple-300 hover:bg-purple-50 dark:hover:bg-gray-600 text-center transition-all">Personalidade OCEAN</a>
      </div>
